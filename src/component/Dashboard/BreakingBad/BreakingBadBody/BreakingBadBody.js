  ...
  return (
    <div className={styles.body}>
      ...
      <p>
        ...
        a total of 62 episodes. It was set and filmed in Albuquerque, New
      ...
      <p>
        White turns to a life of crime, partnering with his former student Jesse
        ...
        the dangers of the criminal underworld.
      </p>{" "}
      <p>
        {" "}
        Breaking Bad is regarded as one of the greatest television series of all
        time, and with 16 Primetime Emmy Awards.
      </p>
    </div>
  );
};
